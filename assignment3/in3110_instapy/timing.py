...
#from in3110_instapy.***filters import get_filter, time_one
from in3110_instapy.python_filters import python_color2gray
from in3110_instapy.numpy_filters import numpy_color2gray
from in3110_instapy.numba_filters import numba_color2gray
from in3110_instapy.cython_filters import cython_color2gray
 ...
 # load the image
    ...
    with open("timing-report.txt", "w") as report_file:
        ...
        for filter_name in filter_names:
            ...
            report_file.write(f"\nTime performed using reference {filename}: {w}x{h}\n")
            print(
